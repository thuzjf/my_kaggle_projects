...
from helpers import save_checkpoint, setup_logger, resume_training, Ploter
...
if __name__ == "__main__":
  ...
  training_set = MyDataset(im_dir, resize_num)
  ...
  criterion = Focalloss(num_class=2, size_average=False)
